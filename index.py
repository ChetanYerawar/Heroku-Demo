# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 14:32:37 2020
...
<html lang="en" dir="ltr">
    ...
    <body>
       ...
       <div class='footer'>
           <div class="contact">
               <a target="_blank" href="https://github.com/ChetanYerawar/Diabetes-Prediction-Deployment"><i class="fab fa-github fa-lg contact-icon"></i></a>
               <a target="_blank" href="https://www.linkedin.com/in/chetanyerawar07"><i class="fab fa-linkedin fa-lg contact-icon"></i></a>
           </div>
           <p class='footer-description'>Made with ❤️ by Chetan Yerawar.</p>
       </div>
